...
import { CONTACT_FACEBOOK, CONTACT_MAIL, CONTACT_TITLE, CONTACT_WEB } from '../../common/constants';
...
class Footer extends Component {
  render() {
    return (
      <footer>
        <FooterBackground>
          <svg className="footer" viewBox="0 5 100 25" preserveAspectRatio="none">
            <defs>
            ...
            <Inlay>
              <Grid container justify="center">
                ...
                <FooterItem container item xs={12} sm={4} direction="column">
                  ...
                  <SocialIcons>
                    <a className="web" href={CONTACT_WEB}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={whiteColor}>
                    ...
                    <a className="facebook" href={CONTACT_FACEBOOK}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={whiteColor}>
